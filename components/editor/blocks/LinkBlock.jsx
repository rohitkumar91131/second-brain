                ...
                <div className="relative flex items-center gap-3 p-3 rounded-lg border border-[#e9e9e7] bg-white hover:bg-[#f9f9f8] transition-colors shadow-sm">
                    ...
                    <div className="flex-1 min-w-0">
                        <a
                            ...
                            className="text-sm font-medium text-[#37352f] hover:text-blue-600 truncate block transition-colors"
                        >
                            {block.content}
                        </a>
                    </div>
                    <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="p-1.5 text-[#9b9a97] hover:text-blue-600 transition-colors"
                    >
                        <ExternalLink size={16} />
                    </a>
                    <button
                        onClick={onDelete}
                        className="absolute -top-2 -right-2 bg-white border border-[#e9e9e7] p-1 rounded-full text-[#9b9a97] hover:text-red-500 opacity-0 group-hover:opacity-100 transition-opacity shadow-sm"
                    >
                        <Minus size={12} />
                    </button>
                </div>
            ) : (
                <div className="relative w-full flex flex-col items-center gap-3 bg-[#f7f7f5]/50 border border-dashed border-[#e9e9e7] rounded-xl p-6 transition-colors hover:bg-[#f7f7f5]">
                    <LinkIcon size={24} className="text-[#9b9a97] opacity-40" />
