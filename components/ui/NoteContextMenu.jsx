            ...
            >
                {isMobile && (
                    <div className="flex items-center justify-between mb-8">
                        <div>
                            <span className="text-sm font-black text-white uppercase tracking-[0.2em]">Note Options</span>
                ...
                <div className="flex flex-col gap-1">
                    <ContextItem
                        icon={isPinned ? <PinOff size={isMobile ? 18 : 14} /> : <Pin size={isMobile ? 18 : 14} />}
                        label={isPinned ? "Unpin Note" : "Pin Note"}
                        onClick={() => { onPin(); onClose(); }}
                        isMobile={isMobile}
                    />
                    <ContextItem
                        icon={<Copy size={isMobile ? 18 : 14} />}
                        label="Copy Content"
                    ...
                    />
                    <ContextItem
                        icon={<Share2 size={isMobile ? 18 : 14} />}
                        label="Share Note"
                        onClick={() => { onShare(); onClose(); }}
                        isMobile={isMobile}
                    />
                    <ContextItem
                        icon={<ExternalLink size={isMobile ? 18 : 14} />}
                        label="Open in New Window"
                        onClick={() => { onOpenNew(); onClose(); }}
                        isMobile={isMobile}
                    />
