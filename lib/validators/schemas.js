...
// For updates we don't want schema defaults to be applied for omitted fields
// Define an explicit partial schema without defaults so missing fields are not overwritten.
export const TaskUpdateSchema = z.object({
    ...
    // Allow toggling a specific date (yyyy-MM-dd) to add/remove from history
...
const BlockItemSchema = z.object({
    id: z.string(),
    type: z.enum(['paragraph', 'heading1', 'heading2', 'heading3', 'bullet', 'toggle', 'divider', 'callout', 'image', 'video', 'table', 'numbered', 'audio']),
...
export const BlockUpdateSchema = z.object({
    ...
    type: z.enum(['paragraph', 'heading1', 'heading2', 'heading3', 'bullet', 'toggle', 'divider', 'callout', 'image', 'video', 'table', 'numbered', 'audio']).optional(),
