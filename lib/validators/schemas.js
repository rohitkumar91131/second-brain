...
// FIXED: Added 'link' to all block enums below
const BlockItemSchema = z.object({
    id: z.string(),
    type: z.enum(['paragraph', 'heading1', 'heading2', 'heading3', 'bullet', 'toggle', 'divider', 'callout', 'image', 'video', 'table', 'numbered', 'audio', 'link']),
...
export const BlockUpdateSchema = z.object({
    ...
    type: z.enum(['paragraph', 'heading1', 'heading2', 'heading3', 'bullet', 'toggle', 'divider', 'callout', 'image', 'video', 'table', 'numbered', 'audio', 'link']).optional(),
